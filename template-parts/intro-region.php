	...
	<div class="intro__inner  container">
		...
		<div class="intro__info">
			<div class="intro__info-text">
				...
				if ($title == 0) :
				?>
					<p class="intro__info-text-heading">Пропуск на МКАД
					<div class="intro__info-text-desc">для <? echo carbon_get_post_meta(get_the_ID(), "region_title_header"); ?> автомобилей</div>
					</p>
				<?php else : ?>
				...
				<?php endif; ?>
				<div class="intro__info-flag">
					<?php
					$region_flag = wp_get_attachment_image_src(carbon_get_the_post_meta('region_flag'), 'full')[0]; ?>
					<img src="<?php echo $region_flag ?>" alt="">
				</div>
			</div>
			<?php //endif;
			?>
