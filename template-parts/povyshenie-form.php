	<section class="feedback">
		<div class="feedback__inner  container">
	        ...
	        if($title == 0):
		      ?>
			<p class="feedback__heading section-heading">Закажите повышение экологического класса ТС уже сейчас</p>
		      <?php else:?>
			<h2 class="feedback__heading section-heading">Закажите повышение экологического класса ТС уже сейчас</h2>
		    <?php endif;?>
			<div class="feedback__form">
				<form action="" class="feedback__form-container" id = "feedbackform">
					...
					<div class="feedback__form-item feedback__form-item-btn action-btn uniSendBtn"  data-formid = "feedbackform" data-mailmsg = "Форма - Повышение эко-класса грузовых автомобилей">Заказать страхование</div>
				</form>
			</div>
		</div>
	</section> <!-- /.feedback -->