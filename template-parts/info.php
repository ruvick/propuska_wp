			...
			<div class="info__banner"> 
				<ul class="info__banner-container">
					<li class="info__banner-item">
						Оформление пропусков на МКАД для грузовиков из *Беларуси требуется для беспрепятственного въезда в дневное и ночное время суток.
					</li>
					<li class="info__banner-item">
						Компания "Пропуска МКАД-ТТК-СК" предоставляет услуги иностранным перевозчикам, в том числе из *Беларуси, кому требуется оформление 
