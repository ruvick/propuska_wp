<section class="docs">
	<div class="docs__inner container">
		...
		if ($title == 0) :
		?>
			<p class="docs__heading  section-heading">Пакет документов для <? echo carbon_get_post_meta(get_the_ID(), "region_title_3"); ?> автомобилей</p>
		<?php else : ?>
			<h2 class="docs__heading  section-heading">Пакет документов для <? echo carbon_get_post_meta(get_the_ID(), "region_title_3"); ?> автомобилей</h2>
		<?php endif; ?>
